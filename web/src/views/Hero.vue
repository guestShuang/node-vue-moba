<template>
  <div class="page-hero" v-if="model">
    ...
    <div>
      ...
      <swiper v-if="model.skills.length > 0">
        <swiper-slide>
          <div>
            ...
            <m-card plain icon="menu1" title="英雄关系">
              ...
              <div class="border-bottom mt-3"></div>
							...
							<!-- 被谁克制 -->
							<div class="fs-x mt-3">被谁克制</div>
              <div v-for="item in model.restraints" :key="item.name"
              class="d-flex pt-3">
                <img :src="item.hero.avatar" alt="" height="50" >
                <p class="flex-1 m-0 ml-3">
                  {{item.description}}
              ...
              <div class="border-bottom mt-3"></div>
							...
							<!-- 克制谁 -->
							<div class="fs-x mt-3">克制谁</div>
              <div v-for="item in model.abnegators" :key="item.name"
              class="d-flex pt-3">
                <img :src="item.hero.avatar" alt="" height="50" >
                <p class="flex-1 m-0 ml-3">
                  {{item.description}}
        ...
        <swiper-slide></swiper-slide>
			...
			<div v-else class="text-center" style="backgroud:#f6f6f6">
				<img src="../assets/images/no_content.jpg" alt="">
			</div>
    </div>
  </div>
</template>
