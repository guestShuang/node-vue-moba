  ...
  router.get('/ad/list', async (req, res) => {
	...
	router.get('/heroes/:id', async (req, res) => {
		const data = await Hero
			...
			.populate('categories items1 items2 partners.hero restraints.hero abnegators.hero')
			.lean()
		res.send(data)
	})
