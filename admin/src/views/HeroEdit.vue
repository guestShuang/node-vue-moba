          ...
          <el-row type="flex" style="flex-wrap:wrap">
            <el-col :md="12" v-for="(item,i) in model.partners" :key="i">
              ...
              <el-form-item>
				...
				<el-tab-pane label="被谁克制" name="restraints">
          <el-button size="small" @click="model.restraints.push({})">
            <i class="el-icon-plus"></i> 添加英雄
          </el-button>
          <el-row type="flex" style="flex-wrap:wrap">
            <el-col :md="12" v-for="(item,i) in model.restraints" :key="i">
              ...
              <el-form-item>
				...
				<el-tab-pane label="克制谁" name="abnegators">
          <el-button size="small" @click="model.abnegators.push({})">
            <i class="el-icon-plus"></i> 添加英雄
          </el-button>
          <el-row type="flex" style="flex-wrap:wrap">
            <el-col :md="12" v-for="(item,i) in model.abnegators" :key="i">
              <el-form-item label="英雄">
                <el-select filterable v-model="item.hero">
                  <el-option 
                  v-for="hero in heroes"
              ...
              <el-form-item>
                <el-button size="small" type="danger" @click="model.abnegators.splice(i, 1)">删除</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
